...
var _index16 = __webpack_require__(126);

var _index17 = _interopRequireDefault(_index16);

var _index18 = __webpack_require__(131);
...
var uiworker = (_uiworker = {
    ...
    Tag: _index15.Tag
}, _defineProperty(_uiworker, 'Loading', _index14.Loading), _defineProperty(_uiworker, 'uiSwitch', _index18.Switch), _uiworker);
...
var install = function install(Vue) {
    ...
    Vue.prototype.$Message = _index17.default;
};
...
exports.default = {
				...
				mounted: function mounted() {
								if (this.value) {
												this.inputvalue = (0, _date2.default)(this.newDate(this.value) || new Date(), this.format);
								}
				}
};
	...
	methods: {
		...
		toggleDropList: function toggleDropList(e) {
			...
			if (this.visible && (this.search || this.remote)) {
				(0, _assist.findChilds)(this, 'Option').forEach(function (option, i) {
		...
		querySearch: function querySearch(value) {
			...
			setTimeout(function () {
				...
				// 触发子组件queryChange事件
				_this2.$children[1].$children.forEach(function (item) {
					// 触发子组件的querychange方法
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    directives: [{
      name: "show",
      rawName: "v-show",
      value: ((!_vm.notFound && !_vm.loadingState)),
      expression: "(!notFound && !loadingState)"
    }],
  ...
  }, [_vm._v(_vm._s(_vm.notFoundTxt))])]), _vm._v(" "), _c('ul', {
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (_vm.remote && _vm.loadingState),
      expression: "remote && loadingState"
    }],
    class: [_vm.prefixCls + '-dropdown-not-found']
  }, [_c('li', {
    class: [_vm.prefixCls + '-item']
  }, [_vm._v(_vm._s(_vm.loadingTxt))])])])], 1)], 1)
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
...
exports.default = {
    ...
    computed: {
        styleHeight: function styleHeight() {
...
var _tag = __webpack_require__(122);
...
Component.options.__file = "D:\\nodejs\\UI-framework\\ui-worker-branch-1.1\\src\\components\\tag\\tag.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-711bba69", Component.options)
  } else {
    hotAPI.reload("data-v-711bba69", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
exports.default = {
	...
	computed: {
		classes: function classes() {
			...
			return ['' + prefixCls, (_ref = {}, _defineProperty(_ref, prefixCls + '-' + this.color, !!this.color), _defineProperty(_ref, prefixCls + '-closable', this.closable), _ref)];
		},
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-711bba69", module.exports)
  }
}
...
Component.options.__file = "D:\\nodejs\\UI-framework\\ui-worker-branch-1.1\\src\\components\\switch\\switch.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-98d7999a", Component.options)
  } else {
    hotAPI.reload("data-v-98d7999a", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
exports.default = {
    ...
    mounted: function mounted() {
        ...
        if (['sm', 'normal', 'lg'].indexOf(this.size) == -1) {
            this.size = 'normal';
        }
    },
    ...
    computed: {
        wrapClass: function wrapClass() {
            ...
            return ['' + prefixCls, (_ref = {}, _defineProperty(_ref, prefixCls + '-checked', this.currentVal === this.trueVal && !this.disabled), _defineProperty(_ref, prefixCls + '-disabled', this.disabled), _defineProperty(_ref, prefixCls + '-' + this.size, ['sm', 'normal', 'lg'].indexOf(this.size) > -1), _ref)];
        },
        innerClass: function innerClass() {
            return prefixCls + '-inner';
        }
    ...
    methods: {
        toggle: function toggle() {
            ...
            var checkedVal = this.currentVal === this.trueVal ? this.falseVal : this.trueVal;
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    class: _vm.innerClass
  }, [(_vm.currentVal === _vm.trueVal) ? _vm._t("open") : _vm._e(), _vm._v(" "), (_vm.currentVal === _vm.falseVal) ? _vm._t("close") : _vm._e()], 2)])
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-98d7999a", module.exports)
  }
}
